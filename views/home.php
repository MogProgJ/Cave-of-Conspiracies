      ...
      <div class="col">
        ...
        <div class="card reveal" style="margin-top:16px;">
          ...
          <p class="helper">
            ...
            <?= !empty($q) ? ' &middot; filtering for "' . htmlspecialchars($q) . '"' : '' ?>
          </p>
          ...
          <ul class="stats-list">
            <?php if (!empty($communities)): foreach ($communities as $community): ?>
              <li>
                ...
                <span class="muted">Posts (7d): <?= (int)$community['posts_7d'] ?> &middot; Comments (7d): <?= (int)$community['comments_7d'] ?></span>
              </li>
            <?php endforeach; else: ?>
            ...
            <?php if (!empty($tickerCommunities)): foreach ($tickerCommunities as $community): ?>
              <li>
                <span class="community-pill">
                  ...
                  <small><?= (int)$community['posts_7d'] ?> posts &middot; <?= (int)$community['comments_7d'] ?> comments</small>
                </span>
              </li>
            <?php endforeach; else: ?>
